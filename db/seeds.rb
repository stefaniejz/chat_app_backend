...
user1 = User.create(username:"Eric", password: '123', avatar:'http://image.bee-ji.com/233220')
user2 = User.create(username:"Zenjo", password: '123', avatar:'https://www.ruan8.com/uploadimg/image/20190801/20190801162208_25373.jpg')
user3 = User.create(username:"Jack", password: '123', avatar:"https://www.qq745.com/uploads/allimg/170714/22-1FG4101U5E0.png")
user4 = User.create(username:"Brian",  password: '123', avatar:"http://img.zz21.com/2015/0427/20150427110202176.jpg")
user5 = User.create(username:"Ziyuan", password: '123', avatar:"http://m.imeitou.com/uploads/allimg/2018051708/zjj3d2km140.jpg")
user6 = User.create(username:"Grace", password: '123', avatar:"http://n.sinaimg.cn/sinacn10112/513/w686h627/20190606/de67-hxyuaph9525998.jpg")
user7 = User.create(username:"Stephanie", password: '123', avatar:"https://pic.qqtn.com/up/2018-3/15222315731259519.jpg")
